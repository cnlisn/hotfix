...
import com.lisn.hotfix_module.utils.FileUtils;
import com.lisn.hotfix_module.utils.FixDexUtils;
...
public class MainActivity extends BaseActivity {
    ...
    private void downloadPatch() {
        ...
        File targetFile = new File(getDir("hotfix", Context.MODE_PRIVATE).
                getAbsolutePath() + File.separator + "classes2.dex");
